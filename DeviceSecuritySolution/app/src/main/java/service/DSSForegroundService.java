...
public class DSSForegroundService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        //Pop-up Login
        Intent loginIntent = new Intent(DSSForegroundService.this, LoginReminderService.class);
        startService(loginIntent);

        //Print watermark
        Intent watermarkIntent = new Intent(DSSForegroundService.this, WatermarkScreenService.class);
    ...
    public void onDestroy() {
        Intent intent = new Intent(this, DSSForegroundService.class);
        startService(intent);
